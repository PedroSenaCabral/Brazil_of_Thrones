...
function hideReg(id_reg) {
    ...
    if(!regSel){
	//console.log("hide");
	random_01=Math.floor(Math.random()*perguntasSul_01.length);

	document.getElementById(id_reg).style.display="none";
	document.getElementById("pergunta_01").innerHTML=perguntasSul_01[random_01].infoConflito;
	regSel=true;
	tentativa=0;

	console.log(perguntasSul_01[random_01].choices[correctAnswer]);
...
if(perguntasSul_01[random_01].choices[correctAnswer]===id_state){
    // se acertou
